...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    CostumerEmail: Attribute.Email;
    Duration: Attribute.Enumeration<['O', 'M', 'A', 'N']>;
    Phone: Attribute.String;
    Postcode: Attribute.String;
    TotalPrice: Attribute.Float;
    ExpectDay: Attribute.String;
    OrderItemList: Attribute.Component<'ordered-item.order-item', true>;
    status: Attribute.Enumeration<
      ['Unpaid', 'Ordered', 'Delivering', 'Delivered', 'Finished', 'Cancelled']
    >;
    UserId: Attribute.BigInteger;
    DeliveryPrice: Attribute.Float;
    GST: Attribute.Float;
    Subtotal: Attribute.Float;
    CancelTime: Attribute.String;
    DeliveryTime: Attribute.String;
    PickedTime: Attribute.String;
    PaidTime: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
